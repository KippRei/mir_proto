...
# bpm_filename = 'separated/htdemucs/twofriends/drums.mp3'
# in_filename = 'separated/htdemucs/twofriends/vocals.mp3'
# out_filename = 'stretched_pitched_friends_vocal.mp3'
